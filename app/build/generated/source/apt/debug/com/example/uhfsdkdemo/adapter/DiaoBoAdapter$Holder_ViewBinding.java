...
public class DiaoBoAdapter$Holder_ViewBinding<T extends DiaoBoAdapter.Holder> implements Unbinder {
  protected T target;

  @UiThread
  public DiaoBoAdapter$Holder_ViewBinding(T target, View source) {
    this.target = target;
