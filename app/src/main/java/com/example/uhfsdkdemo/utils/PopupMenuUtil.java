package com.example.uhfsdkdemo.utils;
...
public class PopupMenuUtil {
    ...
    private LinearLayout llTest1, llTest2, llTest3, llTest4, llTest5, llTest6
            , llTest7, llTest8, llTest9, llTest10, llTest11, llTest12;
    ...
    private void initLayout(Context context) {
        ...
        llTest9 = (LinearLayout) rootVew.findViewById(R.id.test9);
        llTest10 = (LinearLayout) rootVew.findViewById(R.id.test10);
        llTest11 = (LinearLayout) rootVew.findViewById(R.id.test11);
        llTest12 = (LinearLayout) rootVew.findViewById(R.id.test12);
        ...
        llTest9.setOnClickListener(new MViewClick(9, context));
        llTest10.setOnClickListener(new MViewClick(10, context));
        llTest11.setOnClickListener(new MViewClick(11, context));
        llTest12.setOnClickListener(new MViewClick(12, context));
    ...
    private class MViewClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (index == 0) {
                ...
                EventBus.getDefault().post(new String(String.valueOf(index)));
                _close();
            }
        }
    }
