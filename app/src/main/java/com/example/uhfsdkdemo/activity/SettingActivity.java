...
public class SettingActivity extends AppCompatActivity implements OnClickListener{
	private Button button1;//���ð�ť1
	private Button button2;//���ð�ť2
	private Button button3;//���ð�ť1
	private Button button4;//���ð�ť2
	private Spinner spinnerSensitive;//������
	private Spinner spinnerPower;//RF����
	private Spinner spinnerWorkArea;//��������
	private EditText editFrequency;//Ƶ��
