...
import com.example.uhfsdkdemo.activity.DiaoBoInfoActivity;
...
public class DiaoBoAdapter extends RecyclerView.Adapter<DiaoBoAdapter.Holder> {


    private Context mContext;
    private List<DiaoBoResultBean.DiaoBoBean> datas;
    private OnItemClickListener mItemClickListener;

    public DiaoBoAdapter(Context context, List<DiaoBoResultBean.DiaoBoBean> datas) {
        mContext = context;
        this.datas = datas;
    }
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mContext.startActivity(new Intent(mContext, DiaoBoInfoActivity.class).putExtra("data",data));
            }
        });
    }
